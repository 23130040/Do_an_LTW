    ...
    <div class="contents">
        ...
        <form class="orders" method="get" action="${pageContext.request.contextPath}/don-hang-cua-toi">
                                ...
                                <div class="order-products">
                                    <c:forEach var="oi" items="${order.listItem}">
                                        <div class="product">
                                            ...
                                            <span class="price"><fmt:formatNumber value="${oi.price}" type="number" groupingUsed="true"/>đ</span>
                                        </div>
                                    </c:forEach>
                                </div>

                                <div class="order-footer">
                                    <span class="total">Tổng: <fmt:formatNumber value="${order.total_price}" type="number" groupingUsed="true"/>đ</span>
            ...
            <div class="order-group hidden" id="done">
                <c:choose>
                    <c:when test="${not empty doneOrders}">
            ...
            <div class="order-group hidden" id="cancel">
                <c:choose>
                    <c:when test="${not empty cancleOrders}">
                        <c:forEach var="order" items="${cancleOrders}">
                            <div class="order-item" data-status="${order.status}">
