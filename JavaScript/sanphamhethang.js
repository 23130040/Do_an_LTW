...
document.addEventListener("DOMContentLoaded", function () {
    const addToCartButtons = document.querySelectorAll(".add-cart, .buy-now");

    addToCartButtons.forEach(button => {
        button.addEventListener("click", function (e) {
            const productSection = e.target.closest(".product-container");
            const imageBox = productSection.querySelector(".product-images");

            if (imageBox && imageBox.classList.contains("out-of-stock")) {
                e.preventDefault();
